...
const config = {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        sans: ["var(--font-geist-sans)", ...defaultTheme.fontFamily.sans], // Use imported defaultTheme
        mono: ["var(--font-geist-mono)", ...defaultTheme.fontFamily.mono], // Use imported defaultTheme
      },
      colors: {
